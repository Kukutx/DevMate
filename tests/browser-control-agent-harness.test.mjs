...
class FakeContext extends EventEmitter {
  constructor(browser){ super(); this._browser=browser; this.items=[]; this.lastUpload=null; this.lastDrag=null; }
...
class FakeBrowser extends EventEmitter {
  ...
  async newContext(){ this.context=new FakeContext(this); return this.context; }
...
export const chromium = {
  ...
  async launchPersistentContext(){ const browser=new FakeBrowser(); const context=new FakeContext(browser); browser.context=context; return context; }
};
`, 'utf8');
