...
test('changing provider without an explicit public URL clears the previous provider URL', () => {
...
test('Cloudflare Quick always clears stable public URL metadata', () => {
...
test('same provider keeps its stable URL when no URL patch is requested', () => {
...
test('explicit URL accompanies a provider change when supplied in the same operation', () => {
...
test('production still rejects Cloudflare Quick before persisting any result', () => {
